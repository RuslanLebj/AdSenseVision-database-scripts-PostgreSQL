...
(
    ...
    end_time TIME NOT NULL -- Время остановки тряналяции контента
);
...
(
	...
	link VARCHAR(250) -- Адрес файла в файловой системе
);

CREATE TABLE analytics -- Аналитика по каждому показу контента
(
	id SERIAL PRIMARY KEY,	
	media_content_id INT, -- Контент, аналитику котрого записываем
...
(
	id SERIAL PRIMARY KEY,
	serial_number INT, -- Порядковый номер контента в цикле трансляции
